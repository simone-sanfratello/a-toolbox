...
'use strict';var time=require('./time');var array=require('./array');var Tasks=function Tasks(){var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var __tasks=[];this.todo=function(id){if(options.chrono){time.chrono.set(id)}__tasks.push(id)};this.done=function(id){array.remove(__tasks,id);if(__tasks.length<1){if(options.done){options.done()}}if(options.chrono){var _time=time.chrono.get(id);time.chrono.clear(id);return{chrono:_time}}}};module.exports=Tasks;

},{"./array":16,"./time":22}],22:[function(require,module,exports){
...
},{"./object":18}],23:[function(require,module,exports){
