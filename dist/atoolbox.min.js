...
"use strict";var event={Emitter:function Emitter(){var __listners={};var __onceListeners={};var emit=function emit(name){if(__listners[name]){for(var _len=arguments.length,args=Array(_len>1?_len-1:0),_key=1;_key<_len;_key++){args[_key-1]=arguments[_key]}var _iteratorNormalCompletion=true;var _didIteratorError=false;var _iteratorError=undefined;try{for(var _iterator=__listners[name][Symbol.iterator](),_step;!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){var _listener=_step.value;_listener.apply(null,args)}}catch(err){_didIteratorError=true;_iteratorError=err}finally{try{if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return()}}finally{if(_didIteratorError){throw _iteratorError}}}if(__onceListeners[name]){var _iteratorNormalCompletion2=true;var _didIteratorError2=false;var _iteratorError2=undefined;try{for(var _iterator2=__onceListeners[name][Symbol.iterator](),_step2;!(_iteratorNormalCompletion2=(_step2=_iterator2.next()).done);_iteratorNormalCompletion2=true){var _listener2=_step2.value;_listener2.apply(null,args)}}catch(err){_didIteratorError2=true;_iteratorError2=err}finally{try{if(!_iteratorNormalCompletion2&&_iterator2.return){_iterator2.return()}}finally{if(_didIteratorError2){throw _iteratorError2}}}delete __onceListeners[name]}}};var on=function on(name,callback){if(!__listners[name]){__listners[name]=[]}__listners[name].push(callback)};var once=function once(name,callback){if(!__onceListeners[name]){__onceListeners[name]=[]}__onceListeners[name].push(callback)};var off=function off(name,id){delete __listners[name];delete __onceListeners[name]};return{emit:emit,on:on,off:off,once:once}}};module.exports=event;
